...
description: 'Grav で定期的に実行したいプログラムの設定方法を、具体例とともに解説します。'
weight: 60
params:
    srcPath: /advanced/scheduler
---
...
## 手動によるジョブ実行{#manually-running-jobs}
...
## プラグインから提供されるジョブ{#plugin-provided-jobs}
