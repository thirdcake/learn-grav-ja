...
description: 'Grav バージョン 1.7 へのアップデート方法について解説します。'
weight: 30
params:
    srcPath: /advanced/grav-development/grav-17-upgrade-guide
---
...
### アップデートのクイックガイド{#quick-update-guide}
...
### 環境変数とマルチサイト{#environments-and-multi-site}
...
### composer オートローダーを使う{#use-composer-autoloader}
...
### プラグイン・テーマのブループリント(`blueprints.yaml`){#plugin-theme-blueprints-blueprints-yaml}
...
#### 管理パネルが翻訳されない{#untranslated-admin}
...
#### ページブループリントが管理パネル内で機能しない{#page-blueprints-stop-working-in-admin}
...
#### 管理パネル内で CSS スタイルが消える{#missing-css-styling-in-admin}
...
## Grav 1.6 の最新バージョンへ戻す{#reverting-back-to-latest-grav-1-6}
