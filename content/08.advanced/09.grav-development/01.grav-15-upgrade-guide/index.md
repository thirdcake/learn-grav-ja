...
description: 'Grav 1.6 未満から、直接最新バージョンの Grav へ直接アップデートせず、まずは Grav 1.6 へのアップデートをおすすめします。このページでは、まずは Grav 1.6 へのアップデート方法を解説します。'
lastmod: '2025-07-01T00:00:00+09:00'
weight: 10
params:
    srcPath: /advanced/grav-development/grav-15-upgrade-guide
---
...
## Grav 1.6.31 への手順{#step-to-grav-1-6-31}
...
## Grav 1.7 へのアップグレード{#upgrading-to-grav-1-7}
