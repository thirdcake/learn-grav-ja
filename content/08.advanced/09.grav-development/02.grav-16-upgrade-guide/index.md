...
description: 'Grav バージョン 1.6 へアップデートする方法を解説します。'
weight: 20
params:
    srcPath: /advanced/grav-development/grav-16-upgrade-guide
---
...
## デバッグバーの deprecated タブ{#deprecated-debug-bar-tab}
...
> [!Warning]  
> **Deprecated** タブに表示されるのは、そのページで非推奨の呼び出しが検出されたときだけです。
...
##### YAML エラーの探し方{#look-for-these-yaml-errors}
...
### YAML 互換モード{#yaml-compatibility-mode}
...
##### Twig 問題の探し方{#look-for-these-twig-issues}
