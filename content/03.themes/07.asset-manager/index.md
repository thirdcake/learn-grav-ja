...
#### JS および JS モジュール向け{#for-js-and-js-module}
...
## アセットをレンダリングする{#rendering-assets}
...
## 名前付きアセットとコレクション{#named-assets-and-collections}
...
##### 属性のコレクション{#collections-with-attributes}
...
## レンダリングされた CSS/JS アセットの属性変更{#change-attribute-of-the-rendered-css-js-assets}
