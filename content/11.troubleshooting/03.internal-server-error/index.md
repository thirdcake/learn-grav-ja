...
### PHP が動いているかテストする{#test-php-is-working}
...
### パーミッションをチェックする{#check-permissions}

500 エラーは、間違ったパーミッションにより起こります。[パーミッションガイド](../permissions/) をチェックしてください。

### register_globals の問題{#register-globals-issue}
...
### Windows の ThreadStackSize{#threadstacksize-on-windows}
...
### Rewritebase 問題{#rewritebase-problems}
...
### 管理パネルのナビゲーション{#admin-panel-navigation}
