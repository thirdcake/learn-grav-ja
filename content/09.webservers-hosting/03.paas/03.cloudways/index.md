...
weight: 30
params:
    srcPath: /webservers-hosting/paas/cloudways
---
...
## Cloudways に登録{#signing-up-on-cloudways}
...
## Cloudways での Grav のインストールと実行{#installing-and-running-grav-on-cloudways}
...
## Cloudways 上の Grav のメンテナンスとアップデート{#maintenance-updating-grav-on-cloudways}
