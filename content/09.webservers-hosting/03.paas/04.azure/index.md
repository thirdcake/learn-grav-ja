...
weight: 40
params:
    srcPath: /webservers-hosting/paas/azure
---
...
## web.config ファイル{#web-config-file}
...
## Azure で Grav をインストールし実行{#installing-and-running-grav-on-azure}

### Web アプリをセットアップ{#setting-up-your-web-app}
...
### Composer のインストール{#install-composer}
...
### あなたのコードをデプロイ{#deploying-your-code}
