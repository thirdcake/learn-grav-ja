...
weight: 70
params:
    srcPath: /webservers-hosting/shared/alwaysdata
---
...
## マーケットプレイスから Grav をインストール{#install-grav-from-marketplace}
...
## SSH アクセスの設定{#configure-ssh-access}
