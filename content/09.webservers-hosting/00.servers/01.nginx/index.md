...
### nginx.conf の例{#example-nginx-conf}
...
### Grav サイト設定{#grav-site-configuration}
...
### httpoxy 脆弱性の修正{#fix-against-httpoxy-vulnerability}
...
## アセット用の Nginx キャッシュヘッダー{#nginx-cache-headers-for-assets}
