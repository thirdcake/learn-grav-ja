...
## CLI web サーバを使う {#using-the-cli-web-server}
...
## リアルタイムのログ表示 {#real-time-log-display}
...
[CLI Web サーバー](https://www.php.net/manual/ja/features.commandline.webserver.php) に関する PHP のウェブサイトで、より詳しく学べます。
