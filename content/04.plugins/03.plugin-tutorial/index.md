...
weight: 30
params:
    srcPath: /plugins/plugin-tutorial
---
...
## Randomizer プラグインの概要{#randomizer-plugin-overview}
...
#### CLI GPM によるインストール{#install-via-cli-gpm}
...
## ステップ2 - Randomizer プラグインの作成{#step-2-create-randomizer-plugin}
...
## ステップ3 - プラグインの基本{#step-3-plugin-basics}
...
### 機能に必要なアイテム{#required-items-to-function}
...
## ステップ4 - プラグイン設定{#step-4-plugin-configuration}
...
## ステップ5 - ベースとなるプラグイン構造{#step-5-base-plugin-structure}
...
## ステップ6 - イベントの登録{#step-6-subscribed-events}
...
## ステップ7 - プラグインを実行するべきか決定{#step-7-determine-if-the-plugin-should-run}
...
## ステップ8 - ランダムページを表示{#step-8-display-the-random-page}
...
## ステップ10 - 最終的なプラグインclass{#step-10-final-plugin-class}
...
## ブループリントの拡張{#extending-blueprints}
...
## プラグイン設定とページ設定のマージ{#merging-plugin-and-page-configuration}
...
## プラグインで CLI を実装{#implementing-cli-in-your-plugin}
