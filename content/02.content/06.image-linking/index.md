...
### ディレクトリによる相対画像リンク{#directory-relative}
...
### 画像でのメディアアクション{#media-actions-on-images}
...
##### ひとつのクラス属性{#single-class-attribute}
...
##### 複数のクラス属性{#multiple-classes-attributes}
