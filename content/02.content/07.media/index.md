...
## サポート対象のメディアファイル{#supported-media-files}
...
## メディアファイルを置く場所{#where-to-put-your-media-files}
...
## リンクと lightbox{#links-and-lightboxes}
...
## アニメーション/ベクトルファイルのアクション{#animated-vectorized-actions}
...
#### 同じ画像への複数の処理をリセット{#resetting-multiple-calls-to-the-same-image}
...
#### 高密度ディスプレイ{#higher-density-displays}
...
##### メディアクエリとサイズ{#sizes-with-media-queries}
...
##### デリバティブを使ったメディアクエリによるサイズ{#sizes-with-media-queries-using-derivatives}
...
#### 手動のサイズ定義{#manual-size-definition}
