...
### 多言語ページ{#multiple-language-pages}
...
### URLによる言語{#active-language-via-url}
...
### ブラウザでの言語設定{#active-language-via-browser}
...
### セッションベースの有効化言語{#session-based-active-language}
...
### 有効化言語にロケールを設定する{#set-locale-to-the-active-language}
...
### デフォルトの言語プレフィックス{#default-language-prefix}
...
### デフォルトのファイル拡張子{#default-file-extension}
...
### 多言語ルーティング{#multi-language-routing}
...
### 言語ベースのホームページ{#language-based-homepage}
...
### 言語ベースの Twig テンプレート{#language-based-twig-templates}
...
### 変数による翻訳{#translations-with-variables}
...
### プラグインとテーマの言語翻訳{#plugin-and-theme-language-translations}
...
### 環境ベースの言語制御{#environment-based-language-handling}
...
### カスタムのルーティングを使っていたときの言語切り替え{#language-alias-routes}
...
### 特定のドメインでの設定{#setup-with-language-specific-domains}
...
### twigテンプレート中の言語ロジック{#language-logic-in-twig-templates}
