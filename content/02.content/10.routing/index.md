...
## ページレベルのルーティングとリダイレクト{#page-level-route-and-redirect-overrides}
...
## サイトレベルのルーティングとリダイレクト{#site-level-routes-and-redirects}
...
### ルーティングのエイリアス（別名）{#route-aliases}

#### シンプルなエイリアス{#simple-aliases}
...
## ホームへのルーティングを隠す{#hiding-the-home-route}
