...
## コレクション・オブジェクト{#collection-object}
...
## コレクションの定義例{#example-collection-definition}
...
## Twigでコレクションにアクセス{#accessing-collections-in-twig}
...
## コレクションヘッダ{#collection-headers}

Grav に、特定のページはリストページで、子ページを持っていることを知らせるため、以下のような、たくさんの変数が用意されています：

### コレクションの設定値の概要{#summary-of-collection-options}
...
## Root コレクション{#root-collections}

##### @root.pages トップレベルのページ{#atroot-pages-top-level-pages}
...
##### @root.descendants すべてのページ{#atroot-descendants-all-the-pages}
...
##### @root.all すべてのページとモジュール{#atroot-all-all-the-pages-and-modules}
...
## Self コレクション{#self-collections}

##### @self.page 現在のページのみ{#atself-page-current-page-only}
...
##### @self.parent 現在のページの親ページ{#atself-parent-the-parent-page-of-the-current-page}
...
##### @self.siblings 現在ページの兄弟ページ{#atself-siblings-siblings-of-the-current-page}
...
##### @self.children 現在ページの子ページ{#atself-children-children-of-the-current-page}
...
##### @self.modules 現在ページのモジュール{#atself-modules-modules-of-the-current-page}
...
##### @self.all 現在ページの子ページ及びモジュール{#atself-all-children-and-modules-of-the-current-pag}
...
##### @self.descendants 現在ページの子ページ及び、すべての子孫ページ{#atself-descendants-children-all-descendants-of-the}
...
## ページコレクション{#page-collections}

##### @page.page ある特定のページのみのコレクション{#atpage-page-collection-of-just-the-specific-page}
...
##### @page.parent そのページの親ページ{#atpage-parent-the-parent-page-of-a-specific-page}
...
##### @page.siblings そのページの兄弟ページ{#atpage-siblings-siblings-of-a-specific-page}
...
##### @page.children そのページの子ページ{#atpage-children-children-of-a-specific-page}
...
##### @page.modules そのページのモジュール{#atpage-modules-modules-of-a-specific-page}
...
##### @page.all そのページの子ページ及びモジュール{#atpage-all-children-and-modules-of-a-specific-page}
...
##### @page.descendants そのページの子ページ及びすべての子孫ページのコレクション{#atpage-descendants-collection-of-children-all-desc}
...
## タクソノミー・コレクション{#taxonomy-collections}
...
## コレクションオブジェクトのメソッド{#collection-object-methods}
...
## プログラミングによるコレクション{#programmatic-collections}
...
#### 発展的なコレクション{#advanced-collections}
...
#### 発展的なコレクションでのページネーション{#pagination-with-advanced-collections}
...
#### `onCollectionProcessed()` イベントによるカスタムコレクションの制御{#custom-collection-handling-with-oncollectionproces}
